...
/**
 * A list of all sounds in the game as of Minecraft 1.9 to accommodate for the changes
 * in Bukkit's {@link Sound} enum between said version and the last. Names in this enum
 * match those of Bukkit's 1.8 Sound constants, and a Bukkit instance may be retrieved
 * using {@link Sounds#bukkitSound()}
 */
public enum Sounds {
	...
	private final String pre19sound, post19sound;
	...
	/**
	 * Get (and cache) the related Bukkit sound depending on the current server implementation
	 * 
	 * @return the Bukkit sound constant
	 */
